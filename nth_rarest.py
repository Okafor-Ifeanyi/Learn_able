...
def nth_most_rate_signature(list_nums, n):
    ...
    if type(list_nums) is list and type(n) is int: 
        ...
        if n > len(list_nums):
            ...
            # answer
            print(rarest[1])
    # If verification @line 6 fails print
    else:
        print('''   
    ========== Error Message =============
        ...
        ''')
        # print('list_nums = list(), n = integer(). Please crosscheck your values')

# Calling the function and passing values into the function 
